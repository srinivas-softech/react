...
import CustomButton,{ CircleAddBtn, PaginationButtons } from "./CustomButton";
...
const styles = (theme) => ({
  ...
  //Add Purchase Return
  polItem_name: { maxWidth: "250px", minWidth: "250px", whiteSpace:"normal" },
  inv_item_details: { maxWidth: "250px", minWidth: "250px", whiteSpace:"normal" },
});
...
export default function MuiTable({
  ...
  const onClickNextPage = (event) => {
    ...
    onClickNext([pageCount + 1, 10])

  }
  // console.log(pageCount + 1, "sen1010/1")
  ...
  const onClickPreviousPage = (event) => {
    ...
    onClickPrevious([pageCount - 1, 10])
  }
