...
const AddQuatationPage = () => {
    ...
    // if (location.state?.row) {
      ...
      getSalesOrderBySalesIdUpdate(
        ...
        (r) => {
          ...
          r.sales_order_other_charges.map((o, i) => {
  ...
  const onDelete = (e, index) => {
    ...
    let deleteRef = allItems.sales_order_item_details
  ...
  const onClickAdd = () => {
    if (chargesValue != null && chargesValue != undefined && chargesValue != '') {
      ...
      if (otherChargesOption.value === undefined && otherChargesOption1.value === undefined) {
        ...
        allItems.sales_order_other_charges.push(
          {
  ...
  const onClickAddItem = (r) => {
    ...
    if (allItems != []) {
      ...
      if (allItems.sales_order_item_details.find((v, i) => v.item_id === r.item_id)) {
        dispatch({
          type: actionTypes.SET_OPEN_MSG,
        ...
        allItems.sales_order_item_details.push(
        ...
        allItems.sales_order_item_details.map((r, i) => {
  ...
  const onChange = (e, row) => {
    ...
    if (name === `chk_gst${row.item_id}`) {
      ...
      if (e.target.checked) {
        ...
        //console.log(rate, "rate 55");
        //console.log(temp_items, "temp_items 55");
        //console.log(itemDetail, "itemDetail 55");
        //console.log(disc_percentage, "disc_percentage 55")
        //console.log(gst_rate, "gst_rate 55")
  ...
  const onClickSubmitSalesOrder = (e) => {
    ...
    if (customerDetails[0]?.ddl_state_label > 0) {
      ...
      if (allItems.sales_order_item_details.length) {
        allItems.sales_order_item_details.map((item, i) => {
          updatedItem.push({
      ...
      //console.log(updateOtherCharges, "checking")
      updateSalesOrder(
        billDetail,
        updatedItem,
        updateOtherCharges,
                ...
                <Table className={classes.table} aria-label="customized table">
                  ...
                  <TableBody>
                    ...
                    {allItems?.sales_order_item_details &&
                      allItems.sales_order_item_details.map((row, i) => (
                        <StyledTableRow key={i}>
                          <StyledTableCell
                            component="th"
                            scope="row"
              ...
              <Box pt={2}>
                <Grid container>
                  ...
                  <Grid item xs={5}>
                    ...
                    >
                      {currencyFormate(
                        (db_total = allItems.sales_order_item_details
                          ? allItems.sales_order_item_details
                            .reduce(
                              (sum, li) =>
                                Number(sum) +
