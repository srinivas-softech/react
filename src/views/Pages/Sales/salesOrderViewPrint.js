...
const useStyles = makeStyles((theme) => ({
  ...
  amount: { width: "17%" },
  disc: { width: "8%", borderRight: "1px solid " + borderColor },
        ...
        <Grid conatainer justify="center">
          <Grid item xs={12} className={classes.headerDetails}>
            <Grid container>
              ...
              {/* Section Two*/}
              {console.log(salesOrderDetails, "salesOrderDetailsppp")}
                  ...
                  <Grid item xs={6} className={classes.boxBorder0}>
                    ...
                    <Box mt={1} mb={1}>
                      <div className={classes.title_label}>
                        ...
                        {salesOrderDetails.sales_order_no}
                      </div>
                    </Box>
                  </Grid>
                  <Grid item xs={6} className={classes.boxBorder0}>
...
,"sank1012")} */}
                      <div className={classes.title_label}>
                        {salesOrderDetails.sales_order_date}
                      </div>
                    </Box>
                  </Grid>
                  <Grid item xs={6} className={classes.boxBorder0}>
                    <div className={classes.text_label}>Salesman Name</div>
                    <div className={classes.title_label}>
                      {salesOrderDetails.sales_executive_name}
                    </div>
                  </Grid>
              ...
              <Grid item xs={6} className={classes.section_three}>
                ...
                <div className={classes.title_label}>
                  {salesOrderDetails.sales_customer}
                </div>
                <div className={classes.text_label}>
                  {salesOrderDetails.sales_street}
                </div>

                <div className={classes.text_label}>
                  {salesOrderDetails.sales_city} , {"  "}
                  {/* - {salesOrderDetails[0]?.pin}  */}
                  {salesOrderDetails.sales_state}
                </div>

                <div className={classes.text_label}>
                  GSTIN : {salesOrderDetails.gst_no}
          ...
          <div className={classes.tablContainer}>
            <TableContainer>
              <Table className={classes.table} aria-label="customized table">
                ...
                {/* {console.log( itemDetails.sales_order_item_details," salesOrderDetails")} */}
                <TableBody>
                  {itemDetails.sales_order_item_details &&
                    itemDetails.sales_order_item_details?.map((row, i) => {
                      return (
                        <StyledTableRow>
                          <StyledTableCell
                            align="left"
                          ...
                          >
                            ...
                            >
                             <TableBody>
                                  {salesOrderDetails && (
                                    <StyledTableRow key={salesOrderDetails.id} style={{ borderBottom: "None" }}>
                                      <StyledTableCell
                                        style={{ borderBottom: "None" }}
                                        align="right"
                                      >
                                        {Math.round(Number(row?.quantity) / salesOrderDetails.lower_unit_value)} {salesOrderDetails.lower_caption}
                                      </StyledTableCell>
                                    </StyledTableRow>
                                  )}
                                </TableBody>
                          ...
                          >
                            ...
                            >
                              <TableBody>
                                {/* { deliveryDetails?.enqShowroom[i] && deliveryDetails?.enqShowroom[i].map(det => {
                            return (
...
,"sank10121")} */}
                    <StyledTableCell
                      ...
                      className={classes.insideBorder2}
                    >
                      {itemDetails.sales_order_item_details?.length > 0 &&
                        currencyFormate(
                          itemDetails.sales_order_item_details.reduce(
...
: currencyFormate(0)
                  ...
                  {/* othercharges start */}
                  {totalOtherCharges?.sales_order_other_charges?.length > 0 &&
                    totalOtherCharges?.sales_order_other_charges.map(
                      (row, i) => {
                        // console.log(row,"sankothercharges")
                        return (
                          <StyledTableRow>
                            <StyledTableCell
                              colSpan={9}
            ...
            <Grid container>
              <Grid item xs={6} className={classes.footer_two}>
                <StyledTableCell className={classes.footer_one1}>
                  ...
                  <img
                    src={
                      require("../../../assets/img/marudhar-qrcode.jpg").default
                    }
              ...
              <Grid item xs={6} className={classes.footer_three}>
                ...
                <Box m={1}>
                  <div className={classes.title_label_2}>
                    1. Delivery will be in 48 hours from confirmation(unless
                    specified otherwise).
                  </div>
                  <div className={classes.title_label_2}>
                    2. Slight color variations beyond our control may be present
                    in delivered goods.
                  </div>
                  <div className={classes.title_label_2}>
                    3. The customer accepts a breakage risk of 3% of total
                    delivery products.
                  </div>
                </Box>
              </Grid>
