...
import {
  ...
  deleteCustomer,
  getAllGroup,
} from "../../../services/customerLedgerListService";
...
/////////////////////////////////////////////////////////
  ...
  const onhandleExportToExcel = async () => {
    ...
    const titleRow = worksheet.addRow(['Report Name : Customer Ledger List']);
    ...
    const CustomerTable = customers.map((customer) => {
      return {
        id: customer.id,
        group_name: customer.cusLedGroup_name,
        company: customer.cusLedCompany,
        ledger_account: customer.cusLedLedger_account_name,
      };
    });
    ...
    saveAs(data, 'Customer Ledger List .xlsx');
  };
...
const onClickCollaps = () => {
  ...
  return (
    <ThemeProvider theme={theme}>
      <PageTitle
        title="Master > Customer-Ledger List"
      ...
      <>
        <GridContainer className={classes.root}>
          <GridItem xs="12">
            <CustomCard cdTitle="Search Customer-Ledger List"
