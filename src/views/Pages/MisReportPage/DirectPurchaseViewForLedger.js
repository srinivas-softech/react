...
const DirectPurchaseViewForLedger = (grnNo) => {
  ...
  // console.log(grnNo.grnNo,"sen3105/grn")
  React.useEffect(() => {
    getListStatus(
      "Purchase",
      (r) => {
  ...
  return (
    ...
    <h5 align ={"center"} style={{fontWeight:'bold',color:'lightcoral'}}>Direct Purchase View</h5>
      <GridContainer>
        <GridItem xs="12">
                ...
                <TableBody>
                  <StyledTableRow>
                    ...
                    {/* <StyledTableCell align="left" className={classes.enqEmail}>
                      {addedItems.grn_no ? addedItems.grn_no : "Not Approved"}
                    </StyledTableCell> */}
...
export default DirectPurchaseViewForLedger;
