...
const ItemReceivedViewPageForLedger = (grn_no) => {
  ...
  React.useEffect(() => {
    //console.log(grn_no.grn_no,"90901")
    getListStatus(
      "Purchase",
      (r) => {
        setAllStatus(r);
  ...
  return (
    ...
    <h5 align ={"center"} style={{fontWeight:'bold',color:'lightcoral'}}>Purchase View</h5>
...
export default ItemReceivedViewPageForLedger;
