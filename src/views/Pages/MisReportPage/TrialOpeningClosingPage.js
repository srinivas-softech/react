...
const TrialOpeningClosingPage = ({}) => {
  ...
  function exportTableToExcel() {
    ...
    XLSX.utils.book_append_sheet(wb, ws, 'Trialbalance_Opening_Closing');
    XLSX.writeFile(wb, 'Trialbalance_Opening_Closing.xlsx');
  }
          ...
          <div className={classes.inv}>
            Trial Balance
                ...
                <div
                  ...
                  id="table_trial_balance"
                >
                  <TableContainer>
                    <Table
                      className={classes.table}
                      aria-label="customized table"
                      id="excel_table_trial_balance"
                    >
                      <TableHead>
                        <TableRow>
                          <StyledTableCell
                          ...
                          return (
                            <StyledTableRow>
                              ...
                              >
                                {
                                  ...
                                  row.openCrDrStatus === "Dr"
                                    ? currencyFormate(row.opening_balance)
                                    : ""
                                }
                              </StyledTableCell>
                              ...
                              >
                                ...
                                {row.opening_balance > row.closingBalance
                                  ? row.openCrDrStatus === "Cr"
                                    ? row.opening_balance - row.closingBalance
                                    : 0
                                  : row.opening_balance < row.closingBalance
...
export default TrialOpeningClosingPage;
