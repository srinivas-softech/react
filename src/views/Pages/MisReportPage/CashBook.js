...
const CashBook = () => {
  ...
  return (
    <ThemeProvider theme={theme}>
      <PageHeader title="MIS Report > Cash Book" />
      <GridContainer>
        <GridItem xs="12">
          <CustomCard cdTitle="Search Cash Book" filterIcon>
            <Paper elevation="0" className={classes.searchBar}>
              <GridContainer justifyContent="center" alignItems="center">
                <GridItem xs="5">
                  <InputLabel id="label">Cash Book</InputLabel>
                  <ReactSelect
