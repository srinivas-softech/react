...
const OutstandingInvoiceFromStorage = () => {
  ...
  const onClickCollaps = () => {
    ...
    const onhandleExportToExcel = () => {
      ...
      const fileName = 'OutStanding By Invoice'
      const fileType = 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;charset=UTF-8';
      const fileExtension = '.xlsx';
      const ws = XLSX.utils.json_to_sheet(OutstandingByInvoiceTable);
  ...
  return (
    <ThemeProvider theme={theme}>
      <PageHeader title="MIS Report > Outstanding By Invoice From Storage" />
      <GridContainer>
        <GridItem xs="12">
          <CustomCard
            cdTitle=" Outstanding By Invoice Storage"
...
export default OutstandingInvoiceFromStorage;
