...
const ledgerDataStorage = () => {
    ...
    return (
        <ThemeProvider theme={theme}>
            <PageHeader title="MIS Report > Ledger Data Storage " />
            <GridContainer>
                <GridItem xs="12">
                    <CustomCard
                        cdTitle="Ledger Data Storage"
...
export default ledgerDataStorage;
