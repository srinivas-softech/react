...
const headerData = [
  ...
  const onSearchApprovedDirectPurchase = (e) => {
  ...
  return (
    <ThemeProvider theme={theme}>
      <PageTitle
        title="Procurement > Approved Direct Purchase"
        btnToolTip="Add Direct Purchase"
        addBtnLink="/admin/procurement/tobe-approve-direct-purchase"
      />

      <GridContainer>
        <GridItem xs="12">
          <CustomCard cdTitle="Search Approved Direct Purchase" filterIcon>
              ...
              <GridContainer justifyContent="flex-start" alignItems="center">
                ...
                <GridItem xs="3">
                  <div className={classes.searchbtnRight} >
                    ...
                    onClick={onSearchApprovedDirectPurchase}
                    >
                      <SearchIcon />
                    </CustomButton>
      ...
      <GridContainer className={classes.root} style={{ "visibility": viewRes }}>
        <GridItem xs="12">
          <CustomCard cdTitle="Approved Direct Purchase" maxHeight="auto">
