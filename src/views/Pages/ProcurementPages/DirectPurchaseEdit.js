...
const DirectPurchaseEdit = () => {
  ...
  const [addSubmitItem, setaddSubmitItem] = React.useState(false);
  ...
  //console.log(globalState.user?.serial_id,"sank6")
                      ...
                      <StyledTableRow key={i}>
                        ...
                        {/* {//console.log(allItems,"26034")} */}
                          <TextField
                            ...
                            name={`txt_quantity${row.quantity}`}
...
export default DirectPurchaseEdit;
