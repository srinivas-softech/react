...
// import MarudharName from "../../assets/applogo/marudhar-name-nav.jpg";
// import MarudharLogo from "../../assets/applogo/marudhar-logo.png";
import CustomNavMenuList from "./CustomNavMenuList";
  ...
  var brand = (
    <div className={logoClasses}>
      <a href="#" target="_blank" className={logoMini}>
        {/* <img src={MarudharLogo} alt="logo" className={classes.img} /> */}
      </a>
      <a href="#" target="_blank" className={logoNormal}>
        {/* <img src={MarudharName} alt="logo" className={classes.imgLogo} /> */}
      </a>
    </div>
  );
